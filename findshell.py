...
def main():
	...
	print wait+"\n## ------ Welcome to Shell Finder Utility
--{ Developed by Aziz Ezzaher }--
 | هده الأداة تمكنك من الحصول على شيلات الفرفوع على المواقع☠ المخترق من قبل ☠
 | تحميل الأداة من هنا👇👇👇👇👇👇 (https://github.com/ezzaher/shellfinder.git) ------ ##"
